...
export interface MoveItemsToSystemDialogProps {
  open: boolean;
  onClose: () => void;
  selectedItems: Item[];
...
const MoveItemsToSystemDialog = React.memo(
  (props: MoveItemsToSystemDialogProps) => {
    ...
    const [placeIntoSystemError, setPlaceIntoSystemError] =
...
MoveItemsToSystemDialog.displayName = 'MoveItemsToSystemDialog';

export default MoveItemsToSystemDialog;
